...
if [ -d /sys/devices/system/cpu/cpufreq/policy0 ]; then
	...
	if grep 'schedutil' $AGL; then
		if [ -e $AGL ]; then
			...
			echo 4000 > $LGP/schedutil/down_rate_limit_us
		...
		if [ -e $AGL ]; then
			...
			echo 80 883200:83 1248000:85 1401600:95 > $LGP/interactive/target_loads
			...
			echo 364800 > $LGP/interactive/hispeed_freq
			echo 0 595200:100000 1401600:200000 > $LGP/interactive/above_hispeed_delay
...
if [ -d /sys/devices/system/cpu/cpufreq/policy4 ]; then
	...
	if grep 'schedutil' $AGB; then
		...
		if [ -e $AGB ]; then
			...
			echo 75000 1651200:100000 1881600:150000 > $BGP/interactive/above_hispeed_delay
...
# chmod 664 /sys/module/lpm_levels/parameters/*
# chmod 664 /sys/module/lpm_levels/system/perf/*
# chmod 664 /sys/module/lpm_levels/system/pwr/*
# chmod 664 /sys/module/lpm_levels/system/system-pc/*
# chmod 664 /sys/module/lpm_levels/system/system-wfi/*
echo Y > /sys/module/lpm_levels/parameters/sleep_disabled
for i in /sys/module/lpm_levels/system/perf/cpu*; do
   echo Y > $i/pc/idle_enabled
   echo Y > $i/ret/idle_enabled
   echo Y > $i/wfi/idle_enabled
done
echo Y > /sys/module/lpm_levels/system/perf/perf-l2-dynret/idle_enabled
echo Y > /sys/module/lpm_levels/system/perf/perf-l2-pc/idle_enabled
echo Y > /sys/module/lpm_levels/system/perf/perf-l2-ret/idle_enabled
echo Y > /sys/module/lpm_levels/system/perf/perf-l2-wfi/idle_enabled
...
echo Y > /sys/module/lpm_levels/system/pwr/pwr-l2-pc/idle_enabled
echo Y > /sys/module/lpm_levels/system/pwr/pwr-l2-ret/idle_enabled
echo Y > /sys/module/lpm_levels/system/pwr/pwr-l2-wfi/idle_enabled
...
echo "simple_ondemand" >/sys/class/devfreq/soc:qcom,memlat-cpu0/governor
echo 10 >/sys/class/devfreq/soc:qcom,memlat-cpu0/polling_interval
echo "simple_ondemand" >/sys/class/devfreq/soc:qcom,memlat-cpu4/governor
echo 10 >/sys/class/devfreq/soc:qcom,memlat-cpu4/polling_interval
echo "simple_ondemand" >/sys/class/devfreq/soc:qcom,mincpubw/governor
...
echo 25000 > /proc/sys/vm/dirty_writeback_centisecs
